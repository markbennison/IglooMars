...
namespace Igloo
{
    ...
    {
        private static bool _PleaseWaitAcknowledge, _axisXApplied, _axisYApplied, _layerScreenApplied, _layerPlayerApplied, _layerCompositeQuadApplied, _NugetRegistryAdded, _NugetPackageAdded, _tagOutputCameraApplied, _KeijiroAdded, _KlakSpoutAdded, _KlakNDIAdded, _EXTOSCAdded, _EXTOSC_DependencyAdded;
